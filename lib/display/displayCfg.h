...
#define MSG_1_TOUT 10000U //timeout for message 0 [ms]

#define MSG_2 "Follow the route"
#define MSG_2_TOUT 0U //timeout for message 0 [ms]. 0 means no timeout.

#define MSG_3 "All bins collected"
#define MSG_3_TOUT 0U //timeout for message 0 [ms]. 0 means no timeout.
